...
void PointCloudMapping::shutdown()
{
    ...
    std::string filename("globalMap.pcd");
    pcl::PCDWriter writer;
    writer.write(filename,*globalMap);
	cout << "Write globalMap.pcd success!" << endl;
...
{
	pcl::visualization::CloudViewer viewer("DenceCloud Viewer");
